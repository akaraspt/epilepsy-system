function output = phaseE(angle1,angle2,Lf,Hf,Lf2,Hf2,sample_freq)
%% phase synchronsiation for EEG and IBI signal
...
for i = 1:D_1(1)
    for j = 1:D_2(1)
        ...
        [phase(:,i,:),f_i] = phaseSynCFEntropy(a1,a2,Lf,Hf,Lf2,Hf2,sample_freq);
